...
2.0.0 =< [Generator](https://github.com/asyncapi/generator/) < 4.0.0
...
```bash
asyncapi generate fromTemplate https://raw.githubusercontent.com/derberg/python-mqtt-client-template/main/test/fixtures/asyncapi.yml https://github.com/Harsh16gupta/asyncapi-v3-template-final --output myclient --force-write --param server=dev
```
